...
st.header("Use this app to generate random and customized fake faces")
st.subheader("Assests and Sources")
st.write('''This project is inspired from Nvidia Labs [this-person-does-not-exist](https://this-person-does-not-exist.com/en) and done in collaboration with professor under supervised guidance. The models are trained on [CelebA Dataset](https://www.kaggle.com/datasets/jessicali9530/celeba-dataset)
            using a single pytorch's XLA device (Accelerated Linear Algebra Compiler) for 3-3.5 cloud TPU hours. To access source code visit Github Repository [Gituhin/Face-Gen.](https://github.com/Gituhin/Face-Gen/tree/master)
            \n`Novel Touch:` We feature customized generation from facial features. To know more in details visit [Website/FG](https://sites.google.com/view/tuhinsubhrade/worksprojects/face-generator)''')
st.markdown("***")
